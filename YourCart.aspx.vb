...
Partial Class YourCart
    ...
    Function ShowCart(ByVal sCartNo As String) As String
        ...
        sHtml &= "<td style=""width:100px;font-weight: bold;"" align=""center"">" & "Thao tác" & "</td>" & vbCrLf
        sHtml &= "</tr>" & vbCrLf
        For nIJ = 0 To tbl.Rows.Count - 1
            ...
            sHtml &= "<td> <input name=""L" & tbl.Rows(nIJ).Item("Line No_") & """ type=""text"" class=""inputbox right"" style=""width:80px;height:20px;"" value=""" & tbl.Rows(nIJ).Item("Quantity") & """/> </td>" & vbCrLf
            sHtml &= "<td align=""right"">" & Format(tbl.Rows(nIJ).Item("Amount Inc VAT"), "##,###").Replace(",", ".") & "</td>" & vbCrLf
            sHtml &= "<td align=""center"">" & "<a href=""#"" onclick=""del('" & tbl.Rows(nIJ).Item("Line No_") & "')""> Xoá" & "</a>" & "</td>" & vbCrLf
            sHtml &= "</tr>"
