<%@ Page Title="" Language="VB" MasterPageFile="~/Administrator/MasterPage.master" AutoEventWireup="false" CodeFile="ProductGroupList.aspx.vb" Inherits="Administrator_ProductGroupList" %>
...
<ContentTemplate>
  <div style="padding:5px;">
    <table>
        ...
        <tr>
            <td><asp:DropDownList ID="CboFilterDivision" runat="server" CssClass ="inputbox" Width="200" AutoPostBack="true" 
                    OnSelectedIndexChanged="CboFilterDivision_SelectedIndexChanged">
                </asp:DropDownList>
            </td>
            <td><asp:DropDownList ID="CbofilterCategory" runat="server" CssClass ="inputbox" Width="200">
                </asp:DropDownList>
            </td>
            <td><asp:TextBox ID="TxtSearch" runat="server" Width="200"></asp:TextBox>
            </td>
            <td>
  ...
  <div style="margin: 0px auto 0px auto;">
        <asp:GridView ID="grdMenuGroup" runat="server" BackColor="White" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Division" HeaderText="Ngành hàng" SortExpression="No_" />
                <asp:BoundField DataField="Category" HeaderText="Loại hàng" SortExpression="No_" />
    ...
    <asp:Panel ID="Panel1" runat="server" Style="display: none;" CssClass="popup">
        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
            ...
            <div style="width:400px;height:300px;">
                ...
                <div style="height:225px;padding-top:10px;padding-left:20px;" >
                    <div style="margin-top:7px;">Ngành hàng</div>
                    <div>
                        <asp:DropDownList ID="CboDivision" runat="server" CssClass ="inputbox" Width="250" AutoPostBack="true" 
                            OnSelectedIndexChanged="CboDivision_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                    <div style="margin-top:7px;">Loại hàng</div>
                    <div>
                        <asp:DropDownList ID="CboCategory" runat="server" CssClass ="inputbox" Width="250">
                        </asp:DropDownList>
                    </div>
                    <div style="margin-top:7px;">Mã loại hàng</div>
                    <div>
                    ...
                    <div style="margin-top:7px;">Map menu</div>
                    <div>
                        <asp:DropDownList ID="CboMenu" runat="server" CssClass ="inputbox" Width="250">
                        </asp:DropDownList>
                    </div>
