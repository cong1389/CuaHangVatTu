<%@ Page Title="" Language="VB" MasterPageFile="~/Administrator/MasterPage.master" AutoEventWireup="false" CodeFile="ProvinceList.aspx.vb" Inherits="Administrator_ProvinceList" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                ...
                <div style="width:400px;height:300px;">
                    ...
                    <div style="height:225px;padding-top:10px;padding-left:20px;" >
                        <div style="margin-top:0px;">Mã tỉnh thành</div>
                        <div>
                        ...
                        <div style="margin-top:10px;">
                            <asp:CheckBox ID="CKBigcity" runat="server" /> Thành phố lớn 
                        </div>
                         <div style="margin-top:10px;">Số ngày giao hàng min</div>
                        <div>
                           <asp:TextBox ID="TxtNumOfDayMin" runat="server" Width="80"></asp:TextBox>
                        </div>
                        <div style="margin-top:10px;">Số ngày giao hàng max</div>
                        <div>
                           <asp:TextBox ID="TxtNumOfDayMax" runat="server" Width="80"></asp:TextBox>
                        </div>
                        <div style="margin-top:10px;">
