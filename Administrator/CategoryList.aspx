<%@ Page Title="" Language="VB" MasterPageFile="~/Administrator/MasterPage.master" AutoEventWireup="false" CodeFile="CategoryList.aspx.vb" Inherits="Administrator_CategoryList" %>
...
<ContentTemplate>
  <div style="padding:5px;">
    <table>
        ...
        <tr>
            <td><asp:DropDownList ID="CboFilterDivision" runat="server" CssClass ="inputbox" Width="250">
                </asp:DropDownList>
            </td>
            ...
            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                ...
                <div style="width:400px;height:300px;">
                    ...
                    <div style="height:210px;padding-top:10px;padding-left:20px;" >
                        <div style="margin-top:10px;">Ngành hàng</div>
                        <div>
                            <asp:DropDownList ID="CboDivision" runat="server" CssClass ="inputbox" Width="250">
                            </asp:DropDownList>
                        </div>
                        <div style="margin-top:10px;">Mã loại hàng</div>
                        <div>
                        ...
                        <div style="margin-top:10px;">Map menu</div>
                        <div>
