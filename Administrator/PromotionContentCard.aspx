<%@ Page Title="" Language="VB" MasterPageFile="~/Administrator/MasterPage.master" AutoEventWireup="false" CodeFile="PromotionContentCard.aspx.vb" Inherits="Administrator_PromotionContentCard" %>
    ...
    <div style="width: 1010px; margin: 0px auto 0px auto;">
        <table cellspacing="1" style="background: #F1F3F5;">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TxtNo_" runat="server" Width="120px" ReadOnly="True"></asp:TextBox></td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TxtLinkContent" runat="server" Width="300px"></asp:TextBox></td>
    ...
    <script>
        ...
        function CopyValue() {
            ...
            $("#<%=TxtName.ClientID%>").change(function () {
                ...
                if (name != "") {
                    $("#<%=TxtLinkContent.ClientID%>").val(RemoveUnicode(name));
                }
