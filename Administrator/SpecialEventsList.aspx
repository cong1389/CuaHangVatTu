<%@ Page Title="" Language="VB" MasterPageFile="~/Administrator/MasterPage.master" AutoEventWireup="false" CodeFile="SpecialEventsList.aspx.vb" Inherits="Administrator_ContentConsultantList" %>
...
<div style="background-color:#F1F3F5;">
        <table width="100%">
            ...
            <tr>
                <td >
                    <asp:DropDownList ID="CboMenuGroup" runat="server"  Width="150px" CssClass="inputbox">
                    </asp:DropDownList>
                </td>
                <td>
    ...
    <div>
                ...
                <asp:GridView ID="GrContent" runat="server" BackColor="White" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Name" HeaderText="Nhóm" 
                            SortExpression="Name" />
