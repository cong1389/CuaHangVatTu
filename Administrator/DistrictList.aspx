<%@ Page Title="" Language="VB" MasterPageFile="~/Administrator/MasterPage.master" AutoEventWireup="false" CodeFile="DistrictList.aspx.vb" Inherits="Administrator_DistrictList" %>
...
<ContentTemplate>
  <div style="padding:5px;">
    <table>
        ...
        <tr>
            <td>
                <asp:DropDownList ID="CboFilterCity" runat="server" CssClass ="inputbox" Width="250">
                </asp:DropDownList>
            </td>
  ...
  <div style="margin: 0px auto 0px auto;">
        <asp:GridView ID="grdMenuGroup" runat="server" BackColor="White" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Province" HeaderText="Tỉnh thành" SortExpression="No_" />
                <asp:BoundField DataField="Zone" HeaderText="Phân vùng tính phí" SortExpression="No_" />
            ...
            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                ...
                <div style="width:400px;height:300px;">
                    ...
                    <div style="height:210px;padding-top:10px;padding-left:20px;" >
                        <div style="margin-top:10px;">Mã quận huyện</div>
                        <div>
                        ...
                        <div>
                             <asp:DropDownList ID="CboProvine" runat="server" CssClass ="inputbox" Width="250">
                                </asp:DropDownList>
                        </div>
                        <div style="margin-top:10px;">
                            Phân vùng (giao hàng)
                        ...
                        <div>
                             <asp:DropDownList ID="CboZoneCode" runat="server" CssClass ="inputbox" Width="250">
                                </asp:DropDownList>
                        </div>
                        <div style="margin-top:10px;">
