<%@ Page Title="" Language="VB" MasterPageFile="~/Administrator/MasterPage.master" AutoEventWireup="false" CodeFile="Unit.aspx.vb" Inherits="Administrator_Unit" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
        ...
        <div style="width:400px;height:300px;">
            ...
            <div style="height:210px;padding-top:10px;padding-left:20px;">
               <div style="margin-top:30px;">Mã đơn vị tính</div>
               <div>
