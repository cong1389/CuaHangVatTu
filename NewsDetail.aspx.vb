...
Partial Class NewsDetail
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            LoadDataforProductList()
            'LoadNewProducts(typeId)
            LoadHotProducts(1)

            LoadDataProductDetail(Request("catdetailid"))
    ...
    Private Sub LoadDataProductDetail(ByVal stypeId As String)

        Dim SQL As String
        Dim sWhere As String = " AND C.[Link Menu]=" & "'" & stypeId & "'"
        ...
        ltrContent.Text = pData.Rows(0).Item("Content")

    End Sub

    Private Sub LoadDataforProductList()
    ...
    Protected Sub rptProductList_ItemDataBound(ByVal sender As Object, ByVal e As RepeaterItemEventArgs)
        If e.Item.ItemType = ListItemType.Item OrElse e.Item.ItemType = ListItemType.AlternatingItem Then
            If countRow = 0 Or countRow Mod 3 = 0 Then
            ...
            ltrPic.Text = String.Format("<a class='picRind' href='{0}'> <img class='img-responsive' src='{1}'></a>", linkUrl, Utils.CheckExitsImages(GetImgUrl() & "Images/Content/Images/" & drv.Row("Images URL")))
            ...
            countRow = countRow + 1
            If countRow Mod 3 = 0 Or totalProducts = countRow Then
                If flash = True Then
